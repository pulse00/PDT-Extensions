...
import com.dubture.pdt.formatter.internal.ui.preferences.PreferencesAccess;
import com.dubture.pdt.formatter.internal.ui.preferences.PreferencesMessages;
...
public abstract class ProfileConfigurationBlock {
	...
	public ProfileConfigurationBlock(IProject project,
		...
		access.getInstanceScope().getNode(FormatterPlugin.PLUGIN_ID)
	...
	public void performApply() {
		try {
			fCurrContext.getNode(FormatterPlugin.PLUGIN_ID).flush();
			if (fCurrContext != fInstanceScope) {
				fInstanceScope.getNode(FormatterPlugin.PLUGIN_ID).flush();
			}
			propagate();
	...
	public void dispose() {
		if (fPreferenceListener != null) {
			fPreferenceAccess.getInstanceScope()
					.getNode(FormatterPlugin.PLUGIN_ID)
