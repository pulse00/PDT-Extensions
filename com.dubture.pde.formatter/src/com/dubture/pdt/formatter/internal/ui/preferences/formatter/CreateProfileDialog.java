...
public class CreateProfileDialog extends StatusDialog {
	...
	private static final String PREF_OPEN_EDIT_DIALOG = FormatterPlugin.PLUGIN_ID
	...
	public Control createDialogArea(Composite parent) {
		...
		final IDialogSettings dialogSettings = FormatterPlugin.getDefault()
	...
	protected void okPressed() {
		...
		FormatterPlugin.getDefault().getDialogSettings()
