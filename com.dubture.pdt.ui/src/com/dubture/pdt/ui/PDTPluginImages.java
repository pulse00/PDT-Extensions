...
public class PDTPluginImages {
	...
	private static final String NAME_PREFIX = "com.dubture.pdt.ui."; //$NON-NLS-1$
	...
	private static ImageDescriptor create(String prefix, String name, boolean useMissingImageDescriptor) {
		...
		return createImageDescriptor(PDTUIPlugin.getDefault().getBundle(), path, useMissingImageDescriptor);
	}
