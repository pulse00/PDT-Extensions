...
import com.dubture.pdt.formatter.internal.ui.preferences.formatter.ProfileManager.CustomProfile;
import com.dubture.pdt.formatter.internal.ui.preferences.formatter.ProfileManager.Profile;
...
public abstract class ModifyDialog extends StatusDialog implements
	...
	public ModifyDialog(Shell parentShell, Profile profile,
		...
		fKeyPreferredWidth = FormatterPlugin.PLUGIN_ID + dialogPreferencesKey
				+ DS_KEY_PREFERRED_WIDTH;
		fKeyPreferredHight = FormatterPlugin.PLUGIN_ID + dialogPreferencesKey
				+ DS_KEY_PREFERRED_HEIGHT;
		fKeyPreferredX = FormatterPlugin.PLUGIN_ID + dialogPreferencesKey
				+ DS_KEY_PREFERRED_X;
		fKeyPreferredY = FormatterPlugin.PLUGIN_ID + dialogPreferencesKey
				+ DS_KEY_PREFERRED_Y;
		fKeyLastFocus = FormatterPlugin.PLUGIN_ID + dialogPreferencesKey
				+ DS_KEY_LAST_FOCUS;
		...
		fDialogSettings = FormatterPlugin.getDefault().getDialogSettings();
	}
	...
	private void saveButtonPressed() {
		...
		final String lastPath = FormatterPlugin.getDefault()
	...
	private void doValidate() {
		...
		if (!name.equals(fProfile.getName())
			...
			updateStatus(new Status(IStatus.ERROR, FormatterPlugin.PLUGIN_ID,
					FormatterMessages.ModifyDialog_Duplicate_Status));
			return;
		}

		if (fProfile.isBuiltInProfile() || fProfile.isSharedProfile()) {
			updateStatus(new Status(IStatus.INFO, FormatterPlugin.PLUGIN_ID,
