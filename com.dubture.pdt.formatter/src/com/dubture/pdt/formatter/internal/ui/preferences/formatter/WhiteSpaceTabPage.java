...
import com.dubture.pdt.formatter.internal.ui.preferences.formatter.WhiteSpaceOptions.InnerNode;
import com.dubture.pdt.formatter.internal.ui.preferences.formatter.WhiteSpaceOptions.Node;
import com.dubture.pdt.formatter.internal.ui.preferences.formatter.WhiteSpaceOptions.OptionNode;
...
public class WhiteSpaceTabPage extends FormatterTabPage {
	...
	private final class SyntaxComponent implements ISelectionChangedListener,
		...
		private final String PREF_NODE_KEY = FormatterPlugin.PLUGIN_ID
	...
	private final class JavaElementComponent implements
		...
		private final String PREF_INNER_INDEX = FormatterPlugin.PLUGIN_ID
				+ ".formatter_page.white_space.java_view.inner"; //$NON-NLS-1$
		private final String PREF_OPTION_INDEX = FormatterPlugin.PLUGIN_ID
	...
	private final class SwitchComponent extends SelectionAdapter {
		private final String PREF_VIEW_KEY = FormatterPlugin.PLUGIN_ID
